...
## Results
The results can be found in the *viz* folder. Inside, there is a folder for country, and a folder for language. The country folderhas a file for each hashtag, which shows how many tweets included that hashtag for each country. The language folder also has a file for each hashtag, which shows how many tweets incuded that hashtag by language.
